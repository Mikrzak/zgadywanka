...
function StartGame(){
    ...
    var startGuesses, mapMode, guessBonus = 0;
    var distanceArray = [];
    ...
    var guesses = startGuesses;

    var index = Math.floor(Math.random() * uniqueTownArray.length);
    ...
    document.getElementById("townText").innerText = "Miejscowość: " + uniqueTownArray[index].Name;
